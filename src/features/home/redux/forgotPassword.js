  ...
  return dispatch => {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        res => {
          dispatch({
            type: HOME_FORGOT_PASSWORD_SUCCESS,
            data: res,
          });
          resolve(res);
        },
        ...
        err => {
          dispatch({
            type: HOME_FORGOT_PASSWORD_FAILURE,
            data: { error: err },
          });
          reject(err);
        },
...
export function reducer(state, action) {
  switch (action.type) {
    case HOME_FORGOT_PASSWORD_BEGIN:
    ...
    case HOME_FORGOT_PASSWORD_SUCCESS:
      // The request is success
      return {
        ...state,
        forgotPasswordPending: false,
        forgotPasswordError: null,
        forgotsuccess: action.data,
      };

    case HOME_FORGOT_PASSWORD_FAILURE:
    ...
    case HOME_FORGOT_PASSWORD_DISMISS_ERROR:
