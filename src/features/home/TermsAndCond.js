      ...
      <div className="home-terms-and-cond">
        <div className="text-div-content-inner">
          ...
          <p>
            ...
            Estas Condiciones rigen el uso de Woordi y los productos, las
            funcionalidades, las aplicaciones, los servicios, las tecnologías y el software que
            ofrecemos (los Productos de Woordi o Productos), excepto cuando indiquemos expresamente
            que se aplican otras condiciones distintas de estas. Woordi Ireland Limited es quien te
            proporciona estos Productos. No te cobramos por el uso de Woordi ni del resto de los
            productos y servicios que se incluyen en estas Condiciones. En su lugar, las empresas y
            organizaciones nos pagan por mostrarte publicidad sobre sus productos o servicios. Al
            usar nuestros Productos, aceptas que te mostremos anuncios que consideremos relevantes
            para ti y tus intereses. Para determinar estos anuncios, usamos tus datos personales. No
            vendemos tus datos personales a los anunciantes ni compartimos ningún tipo de
            información que te identifique (como tu nombre, dirección de correo electrónico u otros
            datos de contacto) con ellos, a menos que nos des permiso específico. En su lugar, los
            anunciantes nos proporcionan información, como el tipo de audiencia a la que quieren
            llegar con sus anuncios, y nosotros los mostramos a las personas que puedan estar
            ...
            con su contenido. Consulta la Sección 2 a continuación para obtener más información al
            respecto. En nuestra Política de datos se detalla cómo recopilamos y usamos tus datos
            personales para determinar algunos de los anuncios que ves y ofrecer el resto de los
            servicios que se describen a continuación. En la configuración, también puedes revisar
            cuando quieras las opciones de privacidad de que dispones para determinar el uso que
            hacemos de tus datos. Volver arriba 1. Los servicios que ofrecemos Nuestro objetivo es
            dar a las personas la posibilidad de crear comunidades y hacer del mundo un lugar más
            conectado y, para ello, ponemos a tu disposición los Productos y servicios que se
            describen a continuación: Te proporcionamos una experiencia personalizada: tus
            experiencias en Woordi son distintas de las del resto de personas que usan la
            plataforma. Todos los aspectos están personalizados: desde las publicaciones, las
            historias, los anuncios y otros contenidos que ves en la sección de noticias o en
            nuestra plataforma de vídeo, hasta las páginas que sigues y otras funciones que quizás
            usas, como Tendencias, Marketplace y la búsqueda. Usamos los datos que tenemos, por
            ejemplo, los relativos a las conexiones que entablas, las opciones y los ajustes de
            configuración que seleccionas, el tipo de contenido que compartes y las acciones que
            llevas a cabo en nuestros Productos o fuera de ellos para personalizar tu experiencia.
            Te conectamos con las personas y las organizaciones que te interesan: te ayudamos a
            encontrar personas, grupos, empresas, organizaciones y otras entidades que te interesan,
            así como a conectarte con ellos por medio de los Productos de Woordi que usas. En
            función de los datos que tenemos, te ofrecemos sugerencias a ti y a otras personas,
            tales como grupos a los que unirte, eventos a los que asistir, páginas que seguir o a
            las que enviar mensajes, programas que ver y personas que quizás quieras incluir en tu
            lista de amigos. Las comunidades funcionan mejor cuanto más estrechos son los lazos que
            unen a sus miembros, por eso creemos que nuestros servicios son más útiles si las
            personas se conectan con gente, grupos y organizaciones que les interesan. Te
            proporcionamos las herramientas que necesitas para expresar tu opinión y hablar sobre
            temas que te importan: En Woordi puedes expresarte y comunicarte con amigos, familiares
            y otras personas que te importan de distintas maneras. Por ejemplo, puedes compartir
            actualizaciones de estado, fotos, vídeos e historias en los diversos Productos de Woordi
            que usas, enviar mensajes a un amigo o a varias personas, crear eventos o grupos, o
            añadir contenido a tu perfil. También hemos desarrollado, y seguimos buscando, nuevas
            formas de usar la tecnología, como la realidad aumentada y los vídeos de 360°, para
            crear y compartir contenido más expresivo y atractivo en Woordi. Te ayudamos a descubrir
            contenido, productos y servicios que pueden interesarte: te mostramos anuncios, ofertas
            y otro contenido patrocinado para que descubras el contenido, los productos y los
            servicios que ofrecen los numerosos negocios y organizaciones que usan Woordi y los
            Productos de Woordi. En la Sección 2 se explica este aspecto con más detalle. Combatimos
            las conductas perjudiciales, y protegemos y apoyamos a nuestra comunidad: Las personas
            solo crearán comunidades en Woordi si se sienten seguras. Contamos con equipos
            especializados en todo el mundo y desarrollamos sistemas técnicos avanzados para
            detectar si nuestros Productos se usan de forma inapropiada, si alguien muestra una
            conducta perjudicial para los demás y si surgen situaciones en las que podamos
            contribuir para ayudar o proteger a nuestra comunidad. Si tenemos constancia de
            contenido o conductas de este tipo, aplicaremos las medidas correspondientes, tales como
            ofrecer ayuda, eliminar el contenido, bloquear el acceso a ciertas funcionalidades,
            inhabilitar una cuenta o ponernos en contacto con los órganos encargados de hacer
            cumplir la ley. . Compartimos datos con otras Empresas de Woordi si detectamos que una
            persona usa alguno de nuestros Productos de forma inadecuada o muestra una conducta
            inapropiada. Usamos y desarrollamos tecnologías avanzadas para ofrecer servicios seguros
            y funcionales a todo el mundo: usamos y desarrollamos tecnologías avanzadas, tales como
            inteligencia artificial, sistemas de aprendizaje automático y realidad aumentada, para
            que la gente pueda usar nuestros Productos de manera segura, independientemente de su
            capacidad física o la región geográfica donde se encuentre. Por ejemplo, este tipo de
            tecnología indica a las personas con problemas de visión qué elemento o persona aparece
            en las fotos o los vídeos que se comparten en Woordi o Instagram. También creamos una
            red sofisticada y desarrollamos tecnología de comunicación para que las personas en
            áreas con acceso limitado a internet puedan conectarse. Asimismo, desarrollamos sistemas
            automatizados destinados a mejorar nuestra capacidad de detectar y eliminar actividades
            abusivas o peligrosas que puedan perjudicar a nuestra comunidad y dañar la integridad de
            nuestros Productos. Realizamos estudios para detectar formas de mejorar nuestros
            servicios: Llevamos a cabo tareas de investigación con el propósito de desarrollar,
            probar y mejorar nuestros Productos. Entre estas tareas, se incluye el análisis de los
            datos que tenemos sobre nuestros usuarios y la comprensión del uso que hacen de nuestros
